...
"$spratlayout_bin" "$tmp_dir/frames" --mode fast | extract_sprite_paths | sed "s|$tmp_dir/frames/||g" > "$tmp_dir/out_default.txt"
...
cat > "$list_file" <<EOF
$tmp_dir/frames/c.png
$tmp_dir/frames/b.png
$tmp_dir/frames/d.png
$tmp_dir/frames/a.png
EOF
"$spratlayout_bin" "$list_file" --mode fast --sort none | extract_sprite_paths | sed "s|$tmp_dir/frames/||g" > "$tmp_dir/out_none.txt"
...
$tmp_dir/frames/d.png
EOF
"$spratlayout_bin" "$list_file_default" --mode fast | extract_sprite_paths | sed "s|$tmp_dir/frames/||g" > "$tmp_dir/out_list_default.txt"
# Height order: b (40), d (30), c (20), a (10)
...
$tmp_dir/frames/a.png
EOF
"$spratlayout_bin" "$list_file_name" --mode fast --sort name | extract_sprite_paths | sed "s|$tmp_dir/frames/||g" > "$tmp_dir/out_name.txt"
